...
rem /Tp %src_dir%\dictBuilder\*.c 
%cl_exe% %cl_flags% /I%src_dir% /I%src_dir%\common /Tp %src_dir%\common\*.c /Tp %src_dir%\compress\*.c /Tp %src_dir%\decompress\*.c /Fe%lib_name%.dll %link_flags%
